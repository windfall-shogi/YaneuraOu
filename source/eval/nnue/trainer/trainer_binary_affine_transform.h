#pragma once
#ifndef _NNUE_TRAINER_BINARY_AFFINE_TRANSFORM_H_
#define _NNUE_TRAINER_BINARY_AFFINE_TRANSFORM_H_
...
class Trainer<Layers::BinaryAffineTransform<PreviousLayer, OutputDimensions>> {
 private:
  using LayerType =
      Layers::BinaryAffineTransform<PreviousLayer, OutputDimensions>;
...
#endif // !_NNUE_TRAINER_BINARY_AFFINE_TRANSFORM_H_
