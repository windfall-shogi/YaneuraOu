#pragma once
#ifndef _NNUE_TRAINER_BINARY_INNER_PRODUCT_H_
#define _NNUE_TRAINER_BINARY_INNER_PRODUCT_H_
...
class Trainer<Layers::BinaryInnerProduct<PreviousLayer, OutputDimensions>> {
 private:
  using LayerType = Layers::BinaryInnerProduct<PreviousLayer, OutputDimensions>;
...
#endif // !_NNUE_TRAINER_BINARY_INNER_PRODUCT_H_
