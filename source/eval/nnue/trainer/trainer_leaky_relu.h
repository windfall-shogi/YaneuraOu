#pragma once
#ifndef _NNUE_TRAINER_LEAKY_RELU_H_
#define _NNUE_TRAINER_LEAKY_RELU_H_
...
class Trainer<Layers::LeakyReLU<PreviousLayer>> {
private:
  using LayerType = Layers::LeakyReLU<PreviousLayer>;
...
#endif // !_NNUE_TRAINER_LEAKY_RELU_H_
